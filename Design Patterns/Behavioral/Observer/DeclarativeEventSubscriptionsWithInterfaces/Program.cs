...
namespace DeclarativeEventSubscriptionsWithInterfaces
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cb.RegisterAssemblyTypes(ass).AsClosedTypesOf(typeof(ISend<>)).SingleInstance();
            ...
            cb.RegisterAssemblyTypes(ass)
                ...
                .OnActivated(act =>
                {
                    // IHandle<Foo> find every ISend<Foo>.Sender += act.Instance.Handle;
                    ...
                    foreach (var i in interfaces)
                    {
                            ...
                            i.GetGenericTypeDefinition() == typeof(IHandle<>))
                        {
                            ...
                            // ISend<Foo> first must construct!
